...
import { AnalyticsFinalreportsComponent } from './components/page-coordinator/advisor-analytics/analytics-finalreports/analytics-finalreports.component';
import { AnalyticsPerformanceevaluationComponent } from './components/page-coordinator/advisor-analytics/analytics-performanceevaluation/analytics-performanceevaluation.component';
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        path: 'advisor-analytics', component: AdvisorAnalyticsComponent, title: 'Analytics', children:
                            [
                                { path: 'analytics-finalreports', component: AnalyticsFinalreportsComponent, },
                                { path: 'analytics-performanceevaluations', component: AnalyticsPerformanceevaluationComponent, },
                            ]
                    }
                ]
            },
